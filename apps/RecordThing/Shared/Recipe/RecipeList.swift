...
struct RecipeList: View {
    ...
    var products: [ProductDef] {
        ProductDef.all(includingPaid: model.allRecipesUnlocked)
...
//                        .listRowSeparator(.hidden)
        ...
        #endif
        .navigationTitle(Text("Recipes", comment: "Title of the 'recipes' app section showing the list of product recipes."))
