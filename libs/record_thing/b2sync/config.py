...
class B2Config:
    ...
    def __post_init__(self):
        ...
        if not re.match(r'^[a-z0-9-]{3,63}$', self.bucket_name.lower()):
            raise ValueError("Invalid bucket name. Bucket names must be 3-63 characters and contain only lowercase letters, numbers, and hyphens.")
    ...
    def from_file(cls, config_path: str) -> 'B2Config':
        ...
        required_fields = ['bucket_name', 'endpoint_url', 'access_key_id', 'secret_access_key']
